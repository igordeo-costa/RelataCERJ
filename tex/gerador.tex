...
\directlua{
normalize_breaklines(
  "../data/DadosBrutos.csv", % Dados de Entrada
  "../data/DadosBrutosNormalizados.csv" % Dados de Saída
)
}

%%% Carrega os dados normalizados quanto às quebras de linhas
\DTLloaddb{tabela}{../data/DadosBrutosNormalizados.csv}
